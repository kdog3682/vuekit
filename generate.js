...
import {packageManager} from "/home/kdog3682/2024-javascript/js-toolkit/packageManager.js"
import {LineEditor} from "/home/kdog3682/2024-javascript/js-toolkit/LineEditor.js"
...
function getDashedText(file, lnum) {
    const le = new LineEditor(read(file))
    le.pos = lnum - 1
    let a = le.find(/^--/, -1)
    let b = le.find(/^--/, 1)
    if (a == null) {
...
function create({file, lnum}) {
    const text = getDashedText(file, lnum)
